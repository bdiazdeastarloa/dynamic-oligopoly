function [gammahaz,p0vec,Q] = p0process(data,n)

if exist('p0process.mat', 'file')
    load p0process;
else
    [gammahaz,Q,p0vec] = poisson_par(data,n);
    save p0process gammahaz Q p0vec
end

end

function [gamma,Q,p0vec] = poisson_par(data,n)

delta = 1;
[mu,sig,lambda] = ou_calibration(data,delta);
...
function [mu,sig,lambda] = ou_calibration(data,delta)
  n = length(data)-1;
